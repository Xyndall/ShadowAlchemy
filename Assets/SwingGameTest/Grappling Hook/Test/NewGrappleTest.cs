...
public class NewGrappleTest : MonoBehaviour
{
    ...
    {
        if (Physics2D.Raycast(firePoint.position, gunPivot.transform.right * 100))
        {
            RaycastHit2D _hit = Physics2D.Raycast(firePoint.position, gunPivot.transform.right* 100);
